...
- UI component changes and API route / database changes
- Solution editor work and dashboard / problem list work
- Problem import logic and solution authoring logic
- Multiple unrelated API routes in a single step
...
- `prisma/schema.prisma` (schema changes require explicit approval)
- `next.config.ts`
- `tsconfig.json`
